...
if ($usuario_id==""){
	...
	usuario
		(usuario_nombre, usuario_apellido, usuario_email, usuario_clave, usuario_dni, usuario_celular, 
		usuario_img, perfil_id, usuario_activo, usuario_eliminado, usuario_fechareg, usuario_idreg)
	",
	"'$usuario_nombre', '$usuario_apellido', '$usuario_email', '$usuario_clave', '$usuario_dni', '$usuario_celular',
	'$nombrecolocar', '3', '1', '0', '$fechaactual', '$iniuser'");
...
echo "<script language='JavaScript'>window.parent.window.location = 'pacientes'; </script>";
