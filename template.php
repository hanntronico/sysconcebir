    ...
    */
    ...
    function validate_meetings($date){
        ...
        if($start_time_now >= 0){
            ...
            //echo "\n";
            $state = false; 
            $message = "Tu cita de las $date es en $start_time_now minutos";
        }
            ...
            */
            $state = true;
            $message = "Ya puedes ingresar a tu cita de las $date. En $end_time_now minutos termina";
            
        }else{
            $state = false;
            
            $message = "Ya termino tu cita de las $date";   
...
try {
    ...
    if(isset($_SESSION)){
        ...
        */
        ...
        $ok= false;
        $message= "<center>Hoy no tienes citas</center>";
        ...
        foreach($result as $val){
            ...
            if($reponse["state"]){
                ...
                $ok = true;
                $message = "<center>" . $reponse["message"] . "</center>";
                break;
            }else{
                $message = "<center>" . $reponse["message"] . "</center>";
