        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <div class="box-header with-border">
              ...
              <div class="row">
                <div class="col-md-12">
                  <h3 class="box-title" style="line-height: 25px"><i class="fa fa-user"></i> Mi Cuenta </h3>
                </div>
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form target='iframeupload'  action="uploadmicuenta" enctype="multipart/form-data" method="POST">
              <div class="box-body">
                 <div class="row">
                ...
                <div class="row" style="margin-top: 15px">                                       
                    ...
                    <div class="form-group col-md-6" <?php echo $displaynoneespecialidadessedes;?> >
                        <label for="especialidades">Especialidades: <span style="color: red"></span></label>
                        <select class="form-control select2" name="especialidades[]" id="especialidades" multiple="multiple"
                                style="width: 100%;">
                            <?php echo $optionespecialidad;?>
                        </select>
                    </div>   
                    <div class="form-group col-md-6" <?php echo $displaynoneespecialidadessedes;?>>
                        <label for="sedes">Sedes:  <span style="color: red"></span></label>
                        <select class="form-control select2" name="sedes[]" id="sedes" multiple="multiple"
                                style="width: 100%;">
                            <?php echo $optionsede;?>
                        </select>
                    </div>                  
                </div> 
                <div class="row"<?php echo $displaynonepago;?> >                                       
                    <div class="form-group col-md-12">
                      <label for="usuario_paypal">Plataforma de Pago</label>
                    </div>
                    <div class="form-group col-md-4">
                      <label for="usuario_paypal">Email de PayPal <span style="color: red"></span></label>
                      <input type="text" class="form-control" id="usuario_paypal" name="usuario_paypal"  value="<?php echo $usuario_paypal;?>" >
                    </div>
