      ...
      <div class="row">
        ...
        <div class="col-md-6">
            ...
            <div class="custom-control custom-radio">
              <input type="radio" id="q-1-rdb-1" name="question-1" value="si" class="custom-control-input" checked>
              <label class="custom-control-label" for="q-1-rdb-1">Si</label>
            </div>
            <div class="custom-control custom-radio">
              <input type="radio" id="q-1-rdb-2" name="question-1" value="no" class="custom-control-input" >
              <label class="custom-control-label" for="q-1-rdb-2">No</label>
            </div>
        </div>
        
        <div class="form-group col-md-6" id="question-1-selected">
        ...
        <div class="col-md-6">
            ...
            <div class="custom-control custom-radio">
              <input type="radio" id="q-2-rdb-1" name="question-2" value="si" class="custom-control-input" checked>
              <label class="custom-control-label" for="q-2-rdb-1">Si</label>
            </div>
            <div class="custom-control custom-radio">
              <input type="radio" id="q-2-rdb-2" name="question-2" value="no" class="custom-control-input" >
              <label class="custom-control-label" for="q-2-rdb-2">No</label>
            </div>
        </div>
        
        <div class="form-group col-md-6" id="question-2-selected">
            
          <select class="form-control" name="tipo-seguro" id="tipo-seguro">
            <option value="0" selected>Seleccionar seguro</option>
            <option value="1">RIMAC S.A. ENTIDAD PRESTADORA DE SALUD</option>
            <option value="2">RIMAC SEGUROS Y REASEGUROS</option>
            <option value="3">MAPFRE PERU COMPAÑÍA DE SEGUROS Y REASEGUROS S.A.</option>
            <option value="4">MAPFRE PERU S.A. ENTIDAD PRESTADORA DE SALUD</option>
            <option value="5">PACIFICO S.A. ENTIDAD PRESTADORA DE SALUD</option>
            <option value="6">EL PACIFICO PERUUANO-SUIZA CIA SEG Y REA</option>
            <option value="7">ONCOSALUD</option>
            <option value="8">CIGNA INTERNATIONAL</option>
            <option value="9">MSH INTERNATIONAL</option>
          </select>
