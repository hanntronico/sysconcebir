      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form target='iframeupload'  action="uploadmedico" enctype="multipart/form-data" method="POST">
              <div class="box-body">
                 <div class="row">
                ...
                <div class="row">                                       
                    <div class="form-group col-md-12">
                      <label for="usuario_precio">Precio de la Consulta</label>
                    </div>
                    <div class="form-group col-md-3">
                      <label for="usuario_precio">Precio: (puntos para decimales) <span style="color: red"></span></label>
                      <input type="text" class="form-control" id="usuario_precio" name="usuario_precio" placeholder="Ej: 10.00" value="<?php echo $usuario_precio;?>" >
                    </div>
