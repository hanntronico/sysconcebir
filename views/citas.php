            ...
            <div class="box-header with-border">                
                <div class="row">
                  <div class="col-md-8 col-xs-6">
                    <h3 class="box-title"><i class="fa fa-user-md"></i> Citas</h3>
                  </div>
                  <div class="col-md-4 col-xs-6" style="text-align: right; <?php echo $displaynoneagregar;?>">
                    <a href="modificarcita">
                      <button type="button" class="btn btn-success">+ Agregar Cita</button>
                    </a>                 
                  </div>
